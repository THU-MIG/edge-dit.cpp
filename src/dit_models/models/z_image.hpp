...
namespace ZImage {
    ...
    public:
        ...
        ggml_tensor* forward(GGMLRunnerContext* ctx,
            ...
            if (modulation) {
                ...
                auto residual = x;
                x             = dit::modulate(ctx->ggml_ctx, attention_norm1->forward(ctx, x), scale_msa);
                ...
                residual = x;
                x        = dit::modulate(ctx->ggml_ctx, ffn_norm1->forward(ctx, x), scale_mlp);
    ...
    public:
        ...
        ggml_tensor* forward(GGMLRunnerContext* ctx,
            ...
            x          = dit::modulate(ctx->ggml_ctx, x, scale);
