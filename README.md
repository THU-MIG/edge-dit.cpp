...
- **2026-07-24:** 🚀 Added **AWQ-style activation-aware quantization** to `ed-convert` (`--awq`): an offline calibration pass steers low-bit (q4_k) quantization toward the most important input channels. See [CLI usage](docs/cli.md#activation-aware-quantization-awq).
