...
struct ValueRef {
    enum class Kind { Site, Slot } kind = Kind::Site;
    CacheSiteId site = -1;
    CacheSlotId slot = -1;

    static ValueRef of_site(CacheSiteId s) { return {Kind::Site, s, -1}; }
    static ValueRef of_slot(CacheSlotId s) { return {Kind::Slot, -1, s}; }
};
