// Vendored from SageAttention (Apache-2.0). thu-ml/SageAttention csrc/qattn/qk_int_sv_f8_cuda_sm89.cuh
// FP8-E4M3 PV variant (SM89). Only the __global__ kernel template is kept; the torch launcher
// is replaced by raw-pointer host code in ed_cuda_sage_attn.cu. Requires nvcc frontend >= 12.4
// (for e4m3 cvt intrinsics via FP8_CAST_ENABLED) and ptxas >= 8.4 (for FP8 MMA).
#pragma once
#include <cuda_fp16.h>
#include <cuda_bf16.h>
#include <cuda_fp8.h>
