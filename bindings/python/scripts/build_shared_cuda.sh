...
ENABLE_MPI=${EDGE_DIT_ENABLE_MPI:-OFF}
ENABLE_NCCL=${EDGE_DIT_ENABLE_NCCL:-OFF}
ENABLE_PARALLEL=${EDGE_DIT_ENABLE_PARALLEL:-OFF}
ENABLE_CUDNN_SDPA=${EDGE_DIT_ENABLE_CUDNN_SDPA:-OFF}
...
CMAKE_ARGS=(
  ...
  -DED_GGML_CUDA=ON
  -DED_ENABLE_CUDNN_SDPA="${ENABLE_CUDNN_SDPA}"
  -DED_ENABLE_MPI="${ENABLE_MPI}"
  -DED_ENABLE_NCCL="${ENABLE_NCCL}"
  -DED_ENABLE_PARALLEL="${ENABLE_PARALLEL}"
