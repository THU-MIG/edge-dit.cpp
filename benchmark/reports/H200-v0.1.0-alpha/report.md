...
Suite: `readme-main-table`

This report is generated from benchmark result summaries.

## Executive Summary

- Rows: 9 total, 9 successful.
- Workloads: flux1-dev-t2i-1024-s50, qwen-image-t2i-1024-s50, sd3-medium-t2i-1024-s50
- Systems: diffusers, edge-dit.cpp, stable-diffusion.cpp
